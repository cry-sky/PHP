...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
                    ...
                    <tbody>
                        <?php $allPrice=0; foreach($cardItems as $item): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="card.php?action=remove&removeId=<?= $item->id ?>">Remove</a>
                                </td>
                            </tr>
                        ...
                        <tr>
                            ...
                            <td scope="col"><a href="card.php?action=removeAll" style="color: red">Remove all</a></td>
                        </tr>
                    </tbody>
                </table>              
        ...
        <?php endif ?>    
                <a class="btn btn-warning" href='card.php?action=addNew'>Add new product</a>
