        ...
        <ul style="display: flex;justify-content: space-between; flex-wrap: wrap;">
            <?php foreach ($products as $product_id => $product) :?>
                <li class="mb-4 d-inline-block" style="width: 30%;box-shadow: 3px 2px 5px rgba(0, 0, 0,.1);">
                    <strong class="d-block w-100 text-center bg-info text-white"><?= $product['brand'] ?></strong>
                    <div style="width: 95%; margin: 5px auto; display: flex;justify-content: center;"><img style="width: 100%" src="<?= $product['image'] ?>" alt="1"> </div>
                    ...
                    <a class="btn btn-success btn-sm mx-auto d-block w-50 my-2" href="router.php?action=add&product_id=<?= $product_id ?>">
                        Add to card
                    </a>
                </li>
            <?php endforeach?>
